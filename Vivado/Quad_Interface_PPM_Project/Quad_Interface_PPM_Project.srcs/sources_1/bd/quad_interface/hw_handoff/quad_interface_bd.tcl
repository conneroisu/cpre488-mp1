...
proc create_root_design { parentCell } {
  ...
  # Create instance: ppm_detect_gen_v3_0_0, and set properties
  set ppm_detect_gen_v3_0_0 [ create_bd_cell -type ip -vlnv EastburnOhnesorge:user:ppm_detect_gen_v3_0:3.0 ppm_detect_gen_v3_0_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins ppm_detect_gen_v3_0_0/s00_axi]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]

  # Create port connections
  connect_bd_net -net PPM_IN_1 [get_bd_ports PPM_IN] [get_bd_pins ppm_detect_gen_v3_0_0/i_ppm]
  connect_bd_net -net ppm_detect_gen_v3_0_0_o_ppm [get_bd_ports PPM_OUT] [get_bd_pins ppm_detect_gen_v3_0_0/o_ppm]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins ppm_detect_gen_v3_0_0/s00_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins ppm_detect_gen_v3_0_0/s00_axi_aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs ppm_detect_gen_v3_0_0/s00_axi/reg0] -force
