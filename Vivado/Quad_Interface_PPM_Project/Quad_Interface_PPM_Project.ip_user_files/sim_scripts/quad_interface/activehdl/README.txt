...
#
# Generated by export_simulation on Sat Feb 22 19:23:11 -0600 2025
#
################################################################################
...
'-reset_run' switch to the './quad_interface.sh' script.

./quad_interface.sh -reset_run
...
./quad_interface.sh -noclean_files

For more information on the script, please type './quad_interface.sh -help'.
